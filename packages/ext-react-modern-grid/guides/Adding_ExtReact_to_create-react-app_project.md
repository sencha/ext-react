## Adding @sencha/ext-react-modern-grid components to an existing create-react-app project
...
To add @sencha/ext-react-modern-grid to an existing application created with create-react-app, run the following in the root folder of the React app:
