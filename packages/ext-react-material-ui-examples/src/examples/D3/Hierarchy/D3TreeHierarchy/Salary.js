export default Ext.define("ExtReactMaterialUIExamples.reader.Salary", {
    extend: "Ext.data.reader.Json",

    alias: "reader.salary",

    getResponseData: function (...args) {
        const data = KitchenSink.reader.Salary.superclass.getResponseData.call(
            this,
            ...args
        );
