...
const root = {
    ...
    children: [
        ...
        //         { text: 'Proxies', component: Proxies, navIcon: 'icon-drag-proxy' },
        //         { text: 'Handles', component: Handles, navIcon: 'icon-drag-handle' },
        //         { text: 'Groups', component: Groups, navIcon: 'icon-drag-group' },
        //         { text: 'Data', component: Data, navIcon: 'icon-drag-data' },
        //         { text: 'Files', component: Files, navIcon: 'icon-drag-drop-element' }
        //     ]},
        ...
        { text: 'Trees', navIcon: 'icon-trees', children: [
            ...
            { text: 'Tree', premium: false, component: Tree, navIcon: 'icon-trees' },
            { text: 'Editable Tree', premium: false, component: EditableTree, navIcon: 'icon-tree-editable'},
            { text: 'Tree Grid', premium: false, component: TreeGrid, navIcon: 'icon-tree-grid' },
            { text: 'Tree Decorations', premium: false, component:TreeDecorations, navIcon: 'icon-tree-decorations'},
            { text: 'Heterogeneous Tree', premium: false, component: HeterogeneousTree, navIcon: 'icon-heterogeneous-tree'},
        ...
        { text: 'D3', premium: false, navIcon: 'icon-d3', children: [
        ...
        { text: 'Pivot Grids', premium: false, navIcon: 'icon-pivot-grids', children: [
