Ext.define("ExtReactMaterialUIExamples.data.calendar.Week", {}, function () {
    ...
    Ext.ux.ajax.SimManager.register({
        "/ExtReactMaterialUIExamples/CalendarWeek": {
            type: "json",
            data: [
                {
                    id: 1,
                    ...
                    eventStore: {
                        proxy: {
                            type: "ajax",
                            url:
                                "/ExtReactMaterialUIExamples/CalendarWeekEvents/1",
                        },
                    },
                },
                {
                    ...
                    eventStore: {
                        proxy: {
                            type: "ajax",
                            url:
                                "/ExtReactMaterialUIExamples/CalendarWeekEvents/2",
                        },
                    },
                },
            ],
