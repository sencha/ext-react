Ext.define("ExtReactMaterialUIExamples.data.calendar.Day", {}, function () {
    ...
    Ext.ux.ajax.SimManager.register({
        "/ExtReactMaterialUIExamples/CalendarDays": {
            type: "json",
            data: [
                {
                    id: 1,
                    ...
                    eventStore: {
                        proxy: {
                            type: "ajax",
                            url:
                                "/ExtReactMaterialUIExamples/CalendarDaysEvents/1",
                        },
                    },
                },
                {
                    ...
                    eventStore: {
                        proxy: {
                            type: "ajax",
                            url:
                                "/ExtReactMaterialUIExamples/CalendarDaysEvents/2",
                        },
                    },
                },
            ],
