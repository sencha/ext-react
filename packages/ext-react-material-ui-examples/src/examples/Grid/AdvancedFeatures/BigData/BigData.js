...
export default class BigDataGridExample extends Component {
    ...
    store = Ext.create("Ext.data.Store", {
        ...
        proxy: {
            type: "ajax",
            url: "/ExtReactMaterialUIExamples/BigData",
        },
    });
                        ...
                        items: [
                            {
                                ...
                                menu: Ext.os.is.Desktop && {
                                    ...
                                    items: [
                                        ...
                                        {
                                            text: "TSV",
                                            handler: this.exportToTSV,
                                        },
                                        {
                                            text: "HTML",
                                            handler: this.exportToHtml,
                                        },
                                    ],
                                },
                                handler:
                                    !Ext.os.is.Desktop && this.onExportClick,
                            },
                        ],
                    }}
                >
                    ...
                    >
                        <WidgetCell>
                            <Button
                                ...
                                bind={{ tooltip: "Verify {record.fullName}" }}
                                text="VERIFY"
                            />
                        </WidgetCell>
                    </Column>
