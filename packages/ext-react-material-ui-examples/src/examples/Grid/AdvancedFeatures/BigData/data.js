function process(data) {
    return data.map((d) => {
        ...
        d.ratingThisYear = Math.max(
            Math.round(d.rating[d.rating.length - 1] / 2),
            1
        );
...
Ext.ux.ajax.SimManager.register({
    "/ExtReactMaterialUIExamples/BigData": {
        type: "json",
        data: process([
            {
                employeeNo: "455476",
                ...
                avatar:
                    "https://encrypted-tbn2.gstatic.com/images?q=tbn:ANd9GcSdj-gG2gXPkOUJGQ2r-3A5AnIgASv19axozeYMWssSVJyySvBIeQ",
                verified: false,
            },
            {
                employeeNo: "140115",
