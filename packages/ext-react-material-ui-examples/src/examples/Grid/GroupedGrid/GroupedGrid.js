...
export default class GroupedGridExample extends Component {
    store = Ext.create("Ext.data.Store", {
        ...
        proxy: {
            type: "ajax",
            url: "/ExtReactMaterialUIExamples/Restaurants",
        },
                ...
                <Toolbar margin="0 0 20 0" shadow>
                    ...
                    <SegmentedButton key="2" label="Grouping">
                        <Button
                            ...
                            pressed={grouped}
                            text="ON"
                            handler={this.onToggleGrouping.bind(this, true)}
                        />
                        <Button
                            key="2"
                            ui="toolbar-default"
                            pressed={!grouped}
                            text="OFF"
                            handler={this.onToggleGrouping.bind(this, false)}
                        />
                    </SegmentedButton>
                </Toolbar>
