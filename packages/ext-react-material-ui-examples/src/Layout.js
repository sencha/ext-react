    ...
    if (Ext.os.is.Phone) {
      ...
      return (
        ...
        <Nestedlist
          ...
          xtitle='<i class="ext ext-sencha" style="position: relative; top: 1px; margin-right: 4px"></i> ExtReact for Material-UI - Examples'
        ...
        >
          ...
          <Titlebar docked="top" shadow style={{zIndex: 2}}>
                      <Button
                        ...
                        handler={this.goBack}
                      />
                      <Container html="ExtReact for Material-UI">
                      </Container>
          </Titlebar>
            { layout === 'fit' ? example : <Container scrollable={layout==='center'}>{ example }</Container> }
          </Container>
        ...
        <Container layout="hbox" cls="main-background" viewport="true">
          <Container layout="fit" flex={4}>
            <Titlebar docked="top" shadow style={{zIndex: 2}}>
              ...
              <a href="#" className="app-title">ExtReact for Material-UI - Examples - React v{REACT_VERSION}</a>
              <Container
