...
export default function toJSON(component) {
    ...
    var _element$props = element.props,
        ...
        props = _objectWithoutProperties(_element$props, ['children']);
    ...
    if (typeof children === 'string') {
        ...
        // child components
        jsonChildren = _Object$keys(renderedChildren).map(function (key) {
    ...
    Object.defineProperty(object, '$$typeof', {
        value: _Symbol['for']('react.test.json')
    });
...
function includeSerializable(obj) {
    if (Array.isArray(obj)) {
        ...
        for (var _iterator = obj, _isArray = Array.isArray(_iterator), _i = 0, _iterator = _isArray ? _iterator : _getIterator(_iterator);;) {
            var _ref;
